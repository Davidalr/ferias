                    ...
                    <svg width="13px" height="27px" viewBox="0 0 13 27" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        ...
                        <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" >
                            <g id="Group-5" fill="#2C3351">
                                <g >
                                    <path d="M8.2656,27 L2.7536,27 L2.7536,13.676 L-0.0004,13.676 L-0.0004,9.083 L2.7536,9.083 L2.7536,6.33 C2.7536,2.584 4.3086,0.354 8.7286,0.354 L12.4026,0.354 L12.4026,4.948 L10.1066,4.948 C8.3866,4.948 8.2736,5.59 8.2736,6.789 L8.2656,9.083 L12.4306,9.083 L11.9446,13.676 L8.2656,13.676 L8.2656,27 Z" id="Fill-3"></path>
                                </g>
                            </g>
                        </g>
                    </svg>
